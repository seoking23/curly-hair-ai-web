      ...
      <div className="container mx-auto px-4 max-w-6xl">
            ...
            {isSelfieMode ? (
              <div className="text-center">
                <Image
                  ...
                  height={400}
                />
                <p className="text-sm text-muted mt-2">Selfie photo used for analysis</p>
              </div>
            ) : (
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="border border-border-primary rounded-2xl p-6 bg-surface-primary shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-primary">Curl Pattern</h3>
            ...
            <div className="space-y-3">
              ...
              <p className="text-secondary">{analysis.curlPattern.evidence}</p>
          ...
          <div className="border border-border-primary rounded-2xl p-6 bg-surface-primary shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-primary">Hair Porosity</h3>
            ...
            <div className="space-y-3">
              ...
              <p className="text-secondary">{analysis.porosity.evidence}</p>
              ...
              {analysis.porosity.testSuggestions.length > 0 && (
                <div className="mt-4">
                  <h4 className="text-sm font-semibold text-primary mb-2">Learn How to Test:</h4>
          ...
          <div className="border border-border-primary rounded-2xl p-6 bg-surface-primary shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-primary">Hair Density</h3>
            ...
            <div className="space-y-3">
              ...
              <p className="text-secondary">{analysis.density.evidence}</p>
            </div>
          </div>
          ...
          <div className="border border-border-primary rounded-2xl p-6 bg-surface-primary shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-primary">Health Score</h3>
        ...
        {analysis.specificIssues.length > 0 && (
          <div className="border border-border-primary rounded-2xl p-6 bg-surface-primary shadow-sm mb-8">
            ...
            {/* Issue Resources */}
            <div className="mt-6">
              <h4 className="text-lg font-semibold text-primary mb-4">Solutions & Resources:</h4>
              <div className="grid md:grid-cols-2 gap-4">
        ...
        {/* Top Pain Points */}
        <div className="border border-border-primary rounded-2xl p-6 bg-surface-primary shadow-sm mb-8">
          <h3 className="text-xl font-bold text-primary mb-4">Your Top Hair Concerns</h3>
          ...
          <div className="mt-6">
            <h4 className="text-lg font-semibold text-primary mb-4">Expert Solutions:</h4>
        ...
        <div className="text-center">
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-4">
            <button
              ...
              className="bg-success hover:bg-success-hover text-inverse font-bold text-xl px-12 py-4 border border-border-primary transition-all duration-200 rounded-lg shadow-sm hover:shadow-md"
            >
              Get Your Personalized Routine 🎯
            </button>
            <button
              onClick={handleShare}
              className="bg-primary hover:bg-primary-hover text-inverse font-bold text-xl px-12 py-4 border border-border-primary transition-all duration-200 rounded-lg shadow-sm hover:shadow-md flex items-center justify-center gap-2"
            >
            ...
            <button
              ...
              className="bg-warning hover:bg-warning-hover text-inverse font-bold text-xl px-12 py-4 border border-border-primary transition-all duration-200 rounded-lg shadow-sm hover:shadow-md flex items-center justify-center gap-2"
            >
